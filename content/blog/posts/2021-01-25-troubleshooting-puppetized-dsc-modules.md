...
![Initial execution of pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/initial-pry.PNG %})

You can call `ls` in that context to see what methods and variables are available:

![Demonstrating the `ls` command in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/ls-pry.PNG %})

You can type the name of one of the variables, such as `name_hash` and hit enter to see what it is set to:

![Printing the `name_hash` variable in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/name-hash-pry.PNG %})
...
![Running the `whereami` command in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/whereami-pry.PNG %})
...
![Executing independent code in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/execute-pry.PNG %})
...
![Calling the `next` command in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/next-pry.PNG %})
...
![Showing the context that will modify the data variable in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/data-line-pry.PNG %})

Before we run these lines, lets check on some state:

![Printing the initial value of the data variable in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/data-initial-pry.PNG %})

![Printing the value of the valid_attributes variable in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/valid_attributes-pry.PNG %})

![Printing the value of the parameters variable in pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/parameters-pry.PNG %})
...
![Printing the value of the data variable in pry after the select! method is used on it](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/data-selected-pry.PNG %})
...
![Printing the value of the data variable in pry after the reject! method is used on it](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/data-rejected-pry.PNG %})
...
![Showing the result of stepping into a loop in Pry](/devx/assets/2021-01-25-troubleshooting-puppetized-dsc-modules/step-loop-pry.PNG %})
